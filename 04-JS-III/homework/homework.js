...
function mesesDelAño(array) {
 ...
 /*
  ...
  if (tresMeses [0] === "Enero" && tresMeses [1] === "Marzo" && tresMeses[2]=== "Noviembre"){
    //tresMeses = array;
    return tresMeses;
  }else{
...
function breakStatement(numero) {
  ...
  // Tu código:
  var miArray = [];
  var interrumpeEjecucion = false;
  miArray[0] = numero + 2;
  for (let i = 1; i < 10; i++) {
    miArray [i] = miArray [i-1] + 2;
    if (miArray [i]=== i + 1){
      interrumpeEjecucion = true;
      break;
    }    
    
  }
  if (interrumpeEjecucion){
